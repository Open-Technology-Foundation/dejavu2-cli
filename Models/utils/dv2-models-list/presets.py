...
FILTER_PRESETS = {
  "production": ["available:>=:8", "enabled:>=:5"],
  "experimental": ["available:<=:3", "enabled:>=:1"],
  "disabled": ["enabled:equals:0"],
  "unavailable": ["available:equals:0"],
  "vision": ["vision:>=:1"],
  "llm": ["model_category:equals:LLM"],
  "embedding": ["model_category:equals:embed"],
  "anthropic": ["parent:equals:Anthropic"],
  "openai": ["parent:equals:OpenAI"],
  "google": ["parent:equals:Google"],
  "latest": ["model:contains:latest"],
  "large-context": ["context_window:>=:100000"],
  "claude": ["model:starts_with:claude"],
  "gpt": ["model:contains:gpt"],
  "o1": ["model:starts_with:o1"],
  "free": ["token_costs:contains:$0.00"],
}
