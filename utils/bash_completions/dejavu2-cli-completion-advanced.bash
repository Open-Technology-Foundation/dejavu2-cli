...
_dejavu2_cli_completions_advanced() {
  ...
  declare -A option_desc=(
    ...
    ["-k"]="Knowledge base for the query"
    ["--knowledgebase"]="Knowledge base for the query"
    ["-Q"]="Query to send to the knowledge base"
    ["--knowledgebase-query"]="Query to send to the knowledge base"
    ...
    ["-K"]="List all available knowledge bases"
...
dejavu2_cli_completion_help() {
  ...
  echo "  - Dynamic completion for knowledge bases"
